...
export class AuthService {
    ...
    getAllTickets() {
        return this.firestore.collection('tickets').valueChanges();
    }

    getTicketById(uid: string) {
        return this.firestore.collection('tickets').doc(uid).valueChanges();
    }

    addTicket(ticketData: any) {
        return this.firestore.collection('tickets').add(ticketData).then(
            (ticket) => this.updateTicket(ticket.id, {...ticketData, ticketUID: ticket.id})
        );
    }

    updateTicket(uid: string, ticketData: any) {
        return this.firestore.collection('tickets').doc(uid).update(ticketData);
    }

    deleteTicket(uid: string) {
        return this.firestore.collection('tickets').doc(uid).delete();
    }
